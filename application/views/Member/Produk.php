 ...
 <div class="navbar navbar-inverse set-radius-zero" >
   ...
   <div class="just-sec">
       ...
       <div class="col-md-4 ">
                   ...
                   <a href="#"><img class="card-img-top" src="<?php echo site_url()?>assets/admin/uploads/<?php echo $value->gambar; ?>" alt="" width="355" height="270"></a>
            <div class="card-body">
              <h4 class="card-title">
                 ...
                 <ul class="list-group list-group-flush">
                   <b>
                    ...
                    <li class="list-group-item">
                        <center><a href="<?php echo base_url()."index.php/LoginMember"?>" class="btn btn-primary">Pesan</a></center>
                    </li>
                </ul>      
