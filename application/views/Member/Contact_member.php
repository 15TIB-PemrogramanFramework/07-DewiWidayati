...
<br />
                   ...
                   <p>
                     <strong>  Telp : </strong> 081335777688
                   </p>
                    <p>
                     <strong>  E-mail : </strong> Almadani@gmail.com
                   </p>
                    <p >
            ...
            <br>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <img src="<?php echo base_url();?>assets/img/mas.jpg" class="img-responsive " alt="" />
                <center><h2>Ahmad Zamroni</h2></center>
            </div>
